...
function resultados(){
  var cinco = document.getElementById("rc1");
  cinco.style.backgroundColor = "green";

  var seis = document.getElementById("rc2");
  seis.style.backgroundColor = "green";

  var siete = document.getElementById("rc3");
  siete.style.backgroundColor = "green";

  var ocho = document.getElementById("rc4");
  ocho.style.backgroundColor = "green";
